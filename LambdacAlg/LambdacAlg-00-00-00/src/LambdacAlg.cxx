...
#pragma region loop_gamma_check_eta_pi0______________________________________________________________
  ...
  HepLorentzVector eta_pg1r(0, 0, 0, 0), eta_pg2r(0, 0, 0, 0), pi0_pg3r(0, 0, 0, 0), pi0_pg4r(0, 0, 0, 0), p_p4r(0, 0, 0, 0), pip_p4r(0, 0, 0, 0), pim_p4r(0, 0, 0, 0);

  // for best chi2
  HepLorentzVector p_p4_r3c(0, 0, 0, 0), pi0g1_p4_r3c(0, 0, 0, 0), etag1_p4_r3c(0, 0, 0, 0), pi0g2_p4_r3c(0, 0, 0, 0), etag2_p4_r3c(0, 0, 0, 0), pip_p4_r3c(0, 0, 0, 0), pim_p4_r3c(0, 0, 0, 0);
  // for best delta E
  HepLorentzVector pi0g1_p4_1c(0, 0, 0, 0), etag1_p4_1c(0, 0, 0, 0), pi0g2_p4_1c(0, 0, 0, 0), etag2_p4_1c(0, 0, 0, 0);
  double minChi2_r3c = 999999999, minChi2_r2c = 99999999999, deltaE_min1c = 99999999, distance_etaprime=99999;
  double chisq = 0;
      ...
      for (int i_pi0 = 0; i_pi0 < pi0.size(); i_pi0++)
      {
        for (int i_piMin = 0; i_piMin < piMin.size(); i_piMin++)
        {
          for (int i_piPlus = 0; i_piPlus < piPlus.size(); i_piPlus++)
          {
            ...
            if (eta[i_eta].getChild1().getIndex() == pi0[i_pi0].getChild1().getIndex() || eta[i_eta].getChild1().getIndex() == pi0[i_pi0].getChild2().getIndex()) continue;
            if (eta[i_eta].getChild2().getIndex() == pi0[i_pi0].getChild1().getIndex() || eta[i_eta].getChild2().getIndex() == pi0[i_pi0].getChild2().getIndex()) continue;
            ...
            // ______________________________  minimum mass etaprime ____________________________________
            // cut for sigma
  ...
  if(m_rightflag == 1 || m_rightflag == -1)
  {
    ...
    if (m_debug)
      cout << __LINE__ << " m_pi0m " << m_pi0m << " m_etam " << m_etam << " m_Sigmam " << m_Sigmam << " m_etaprimem " << m_etaprimem << endl;
    ...
    if(m_debug)
      cout << __LINE__ << " m_pi0m1c " << m_pi0m1c << " m_etam1c " << m_etam1c << " m_Sigmam1c " <<  m_Sigmam1c << " m_etaprimem1c " <<  m_etaprimem1c << endl;
...
StatusCode LambdacAlg::finalize()
{
  ...
  cout << "-------------------------------           -------------------------------" << endl;
  cout << "--------------------                                ---------------------" << endl;
  cout << "------------- 6c7169d min etaprime 1c , v100 ------------------" << endl;
  cout << "--------------------                               ----------------------" << endl;
  cout << "------------------------------           --------------------------------" << endl;
  cout << "-------------------------------------------------------------------------" << endl;
