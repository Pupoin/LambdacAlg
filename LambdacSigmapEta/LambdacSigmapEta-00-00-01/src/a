...
const double xmass[5] = {
  0.000511, 0.105658, 0.139570, 0.493677, 0.9382723
}; // 0.9382723 proton
...
public:
  ...
  double chisquare_4C;
  // p4 after 4C
  HepLorentzVector p4_gam1_pi0_sigma_4C, p4_gam2_pi0_sigma_4C,
      p4_proton_sigma_4C;
  ...
  double msigma;
  // p4 before 3C
  HepLorentzVector p4_gam1_pi0_sigma_old, p4_gam2_pi0_sigma_old,
      p4_proton_sigma_old;
...
int Ntotal(0), Ncut0(0), Ncut1(0), Ncut2(0), Ncut3(0), Ncut4(0), Ncut5(0),
    Ncut6(0), Ncut7(0), Ncut8(0), Ncut9(0);
int Ncharge(0), Nproton(0), Nanti_proton(0), Ngamma(0), Nlambdac(0),
    Nanti_lambdac(0);
int i, j, k, runNo, eventNo;

HepLorentzVector LambdacSigmapEta::getP4(RecEmcShower *gTrk,
                                         Hep3Vector origin) {
...
LambdacSigmapEta::LambdacSigmapEta(const std::string &name,
  ...
  declareProperty("SigmaMinMassCut",
                  m_SigmaminMass = 1.10); // tight cut 1.176 , loose cut 1.10
  declareProperty("SigmaMaxMassCut",
                  m_SigmamaxMass = 1.27); // tight cut 1.20 , loose cut 1.27
  declareProperty("SigmaMassFit", m_SigmaMassFit = 1.18937);

  declareProperty("Pi0MinMassCut",
                  m_Pi0minMass = 0.08); // tight cut 0.115 , loose cut 0.100
  declareProperty("Pi0MaxMassCut",
                  m_Pi0maxMass = 0.180); // tight cut 0.150 , loose cut 0.180
  declareProperty("Pi0MassFit", m_Pi0MassFit = 0.134977);

  declareProperty("EtaMinMassCut",
                  m_EtaminMass = 0.46); // tight cut  , loose cut 0.46
  declareProperty("EtaMaxMassCut",
                  m_EtamaxMass = 0.60); // tight cut  , loose cut 0.60
...
LambdacSigmapEta::~LambdacSigmapEta() {
  if (m_debug)
    std::cerr << __LINE__ << "!!!!!!!!!!m_debug begin deconstructor !!!!!!!!!!"
              << std::endl;
...
StatusCode LambdacSigmapEta::initialize() {
  ...
  if (m_debug)
    std::cerr << __LINE__ << "!!!!!!!!!!m_debug begin initialize !!!!!!!!!!"
              << std::endl;
  m_beta.setX(0.011);
  m_beta.setY(0);
  m_beta.setZ(0);
  ...
  if (nt1)
    ...
    m_tuple1 = ntupleSvc()->book("FILE1/SigmapEta", CLID_ColumnWiseTuple,
                                 "Lambdac to SigmapEta");
    if (m_tuple1) {
      ...
      status = m_tuple1->addIndexedItem(
          "chi2_4C", m_isig, m_chisq_4C); // for choose best candidate
      ...
      // pi0
      // status = m_tuple1->addIndexedItem("p4_of_Gamma1_Pi0_before_4C", m_isig,
      // 4, m_Gam1_Pi0_p4_old); //cut pi0 mass
      // status = m_tuple1->addIndexedItem("p4_of_Gamma2_Pi0_before_4C", m_isig,
      // 4, m_Gam2_Pi0_p4_old); //cut pi0 mass
      // status = m_tuple1->addIndexedItem("p4_of_Gamma1_Pi0_after_4C", m_isig,
      // 4, m_Gam1_Pi0_p4);      //for mbc
      // status = m_tuple1->addIndexedItem("p4_of_Gamma2_Pi0_after_4C", m_isig,
      // 4, m_Gam2_Pi0_p4);      //for mbc
      // eta
      status = m_tuple1->addIndexedItem("p4_of_Gamma1_Eta_before_4C", m_isig, 4,
                                        m_Gam1_Eta_p4_old); // cut eta mass
      status = m_tuple1->addIndexedItem("p4_of_Gamma2_Eta_before_4C", m_isig, 4,
                                        m_Gam2_Eta_p4_old); // cut eta mass
      status = m_tuple1->addIndexedItem("p4_of_Gamma1_Eta_after_4C", m_isig, 4,
                                        m_Gam1_Eta_p4); // for mbc
      status = m_tuple1->addIndexedItem("p4_of_Gamma2_Eta_after_4C", m_isig, 4,
                                        m_Gam2_Eta_p4); // for mbc
      // sigma+
      status =
          m_tuple1->addIndexedItem("p4_of_gamma1_pi0_Sigma_after_4C", m_isig, 4,
                                   m_gam1_pi0_Sigma_p4); // for mbc
      status =
          m_tuple1->addIndexedItem("p4_of_gamma2_pi0_Sigma_after_4C", m_isig, 4,
                                   m_gam2_pi0_Sigma_p4); // for mbc
      status = m_tuple1->addIndexedItem("p4_of_proton_Sigma_after_4C", m_isig,
                                        4, m_p_Sigma_p4); // for mbc

      status =
          m_tuple1->addIndexedItem("p4_of_gamma1_pi0_Sigma_before_4C", m_isig,
                                   4, m_gam1_pi0_Sigma_p4_old); // cut pi0 mass
      status =
          m_tuple1->addIndexedItem("p4_of_gamma2_pi0_Sigma_before_4C", m_isig,
                                   4, m_gam2_pi0_Sigma_p4_old); // cut pi0 mass
      status = m_tuple1->addIndexedItem("p4_of_proton_Sigma_before_4C", m_isig,
                                        4, m_p_Sigma_p4_old); // cut sigma mass
      status =
          m_tuple1->addIndexedItem("p4_of_gamma1_pi0_Sigma_after_3C", m_isig, 4,
                                   m_gam1_pi0_Sigma_p4_3C); // cut sigma mass
      status =
          m_tuple1->addIndexedItem("p4_of_gamma2_pi0_Sigma_after_3C", m_isig, 4,
                                   m_gam2_pi0_Sigma_p4_3C); // cut sigma mass
  ...
  if (m_getmcinfo) {
    ...
    if (nt2)
      ...
      m_tuple2 =
          ntupleSvc()->book("FILE1/SigmapEta_truth", CLID_ColumnWiseTuple,
                            "Lambdac to SigmapEta");
      if (m_tuple2) {
...
StatusCode LambdacSigmapEta::beginRun() {
  if (m_debug)
    std::cerr << __LINE__ << "!!!!!!!!!!m_debug begin beginRun !!!!!!!!!!"
              << std::endl;
  MsgStream log(msgSvc(), name());
...
StatusCode LambdacSigmapEta::execute() {
  ...
  if (m_debug)
    std::cerr << __LINE__ << "!!!!!!!!!!m_debug begin execute !!!!!!!!!!"
              << std::endl;
  Ntotal++;
  MsgStream log(msgSvc(), name());
  ...
  if (m_debug)
    std::cerr << __LINE__ << "runNo=" << runNo << "  ,  eventNo=" << eventNo
              << std::endl;
  ...
  if (m_debug)
    std::cerr << __LINE__ << " mode1 = " << mode1 << " mode2 = " << mode2
              << " mode3 = " << mode3 << std::endl;
  if (m_debug)
  ...
  if (eventHeader->runNumber() < 0) {
    ...
    if (!mcParticleCol) {
      ...
      for (; iter_mc != mcParticleCol->end(); iter_mc++) {
        ...
        if (m_debug)
          std::cerr << __LINE__ << "pdg:" << pdg << "  mpgd:" << motherpdg
                    << "  mmpgd:" << mmotherpdg << "  mmmpgd:" << mmmotherpdg
                    << std::endl;

        if (pdg == 4122 && motherpdg == 9030443) { // psi -> Lambda_c+
          Lmdc_P = true;
          const SmartRefVector<Event::McParticle> &gc =
              (*iter_mc)->daughterList(); // lambdac+ -> sigma+ pi0 pi0
        ...
        if (pdg == 3222 && motherpdg == 4122 &&
            mmotherpdg == 9030443) { // psi -> Lambda_c+ -> Sigma+
          const SmartRefVector<Event::McParticle> &gc =
              (*iter_mc)->daughterList();
          for (unsigned int ii = 0; ii < gc.size(); ii++) {
            if (gc[ii]->particleProperty() == -22)
              continue;
            Ap_id[ndaughterAp] = gc[ii]->particleProperty();
        ...
        if (pdg == 221 && motherpdg == 4122 &&
            mmotherpdg == 9030443) { // psi -> Lambda_c+ -> eta
          const SmartRefVector<Event::McParticle> &gc =
              (*iter_mc)->daughterList();
          for (unsigned int ii = 0; ii < gc.size(); ii++) {
            if (gc[ii]->particleProperty() == -22)
        ...
        if (pdg == 111 && motherpdg == 3222 && mmotherpdg == 4122 &&
            mmmotherpdg == 9030443) { // psi -> Lambda_c+ -> Sigma+ -> pi0
          const SmartRefVector<Event::McParticle> &gc =
              (*iter_mc)->daughterList();
          for (unsigned int ii = 0; ii < gc.size(); ii++) {
            if (gc[ii]->particleProperty() == -22)
      ...
      for (iter_mc = mcParticleCol->begin(); iter_mc != mcParticleCol->end();
        ...
        if ((*iter_mc)->particleProperty() ==
            -4122) { // 4122 Lambdac+    -4122 Lambdac-
        ...
        if ((*iter_mc)->particleProperty() == 4122) {
          ...
          for (int i = 0; i != pdgid.size(); i++) {
            M_pdgid_p[i] = pdgid[i];
            //						if(m_debug)
            //cout<<"M_pdgid_p[i]="<<M_pdgid_p[i]<<endl;
            M_motheridx_p[i] = motherindex[i];
            //						if(m_debug)
            //cout<<"M_motheridx_p[i]="<<M_motheridx_p[i]<<endl;
          }
        }
        pdgid.clear();
        motherindex.clear();
  ...
  if (m_debug)
    std::cerr << __LINE__
              << "!!!!!!!!!!begin Proton and Anti-Proton Selection!!!!!!!!!!"
              << std::endl;
  ...
  //**************************obtain 4-momentum of proton and
  //anti_proton**************************
  Vp4 p_pp, p_pm;
  p_pp.clear();
  p_pm.clear();
  ...
  //**************************finish obtaining 4-momentum of proton and
  //anti_proton**************************

  //*************************Begin to choose good shower for
  //gamma*********************
  ...
  if (m_debug)
    std::cerr << __LINE__ << "!!!!!!!!!!begin choose good gamma !!!!!!!!!!"
              << std::endl;
  ...
  for (int i = evtRecEvent->totalCharged(); i < evtRecEvent->totalTracks();
    ...
    // cut angle between anti-proton and gamma , do nothing with gamma and other
    // charged track
    double dang = 200.;
    ...
    if (!((fabs(cosThetaSh) < m_maxCosThetaBarrel && eraw > m_minEnergy) ||
          ((fabs(cosThetaSh) > m_minCosThetaEndcap) &&
  ...
  //*******************  begin 3C fit for 2-pi0 & 1-eta and 4C for 2-pi0 & 1-eta
  //& 1-sigma+ **********************
  if (m_debug)
    std::cerr << __LINE__ << "!!!!!!!!!! begin 3+4C fit  !!!!!!!!!!"
              << std::endl;
        ...
        for (int o = n + 1; o < nGam; o++) {
          ...
          if (!okvs)
            ...
            for (int i = 0; i < npp; i++) {
              ...
              WTrackParameter wpptrk(xmass[4], ppTrk->getZHelixP(),
                                     ppTrk->getZErrorP());

              // cut sigma mass
              HepLorentzVector p4_Sigmap =
                  p_pp[i] + gamma1_sigma_3C + gamma2_sigma_3C;
              double Mass_sigma = p4_Sigmap.m();
              if ((Mass_sigma <= m_SigmaminMass) ||
                  (Mass_sigma >= m_SigmamaxMass))
                continue;
  ...
  if (m_debug)
    std::cerr << __LINE__
              << "!!!!!!!!!! finish 3+4C fit for lambdac+  !!!!!!!!!!"
              << std::endl;

  //*******************  begin loop anti-sigma- pi0  **********************
  if (m_debug)
    std::cerr << __LINE__
              << "!!!!!!!!!! begin 3+4C fit for lambdac-  !!!!!!!!!!"
              << std::endl;
        ...
        for (int o = n + 1; o < nGam; o++) {
          ...
          if (!okvs)
            ...
            for (int i = 0; i < npm; i++) {
              ...
              RecMdcKalTrack::setPidType(RecMdcKalTrack::proton);
              WTrackParameter wpmtrk(xmass[4], pmTrk->getZHelixP(),
                                     pmTrk->getZErrorP());

              // cut sigma mass
              HepLorentzVector p4_Sigmam =
                  p_pm[i] + gamma1_sigma_3C + gamma2_sigma_3C;
  ...
  if (m_debug)
    std::cerr << __LINE__ << "isig_Lcp = " << isig_Lcp
              << " isig_Lcm = " << isig_Lcm << std::endl;
  if (m_debug)
    std::cerr << __LINE__ << "writeflag=" << writeflag
              << " , mwriteflag=" << mwriteflag << std::endl;
...
*/
  ...
  if (m_debug)
  std:
  cerr << __LINE__ << "!!!!!!!!!!m_debug Begin loop Lambdac+ !!!!!!!!!!"
       << endl;
  ...
  if (writeflag) {
    ...
    for (int isig = 0; isig < isig_Lcp; isig++) {
      ...
      HepLorentzVector p4_sigma_4C = lcp[isig].p4_gam1_pi0_sigma_4C +
                                     lcp[isig].p4_gam2_pi0_sigma_4C +
                                     lcp[isig].p4_proton_sigma_4C;
      // HepLorentzVector p4_pi0_4C = lcp[isig].p4_gam1_pi0_4C +
      // lcp[isig].p4_gam2_pi0_4C;
      HepLorentzVector p4_eta_4C =
          lcp[isig].p4_gam1_eta_4C + lcp[isig].p4_gam2_eta_4C;
      ...
      // HepLorentzVector p_pi0 = lcp[isig].p4_gam1_pi0_sigma_4C +
      // lcp[isig].p4_gam2_pi0_sigma_4C;
  ...
  if (m_debug)
    std::cerr << __LINE__
              << "******************** finish write lambdac+ ******************"
              << std::endl;

  //******************* begin for Anti-Lambdac-
  //Decay****************************
  if (m_debug)
    std::cerr << __LINE__
              << "!!!!!!!!!!m_debug Begin loop anti-Lambdac- !!!!!!!!!!"
              << endl;
  ...
  if (mwriteflag) {
    ...
    for (int isig = 0; isig < isig_Lcm; isig++) {
      ...
      HepLorentzVector p4_sigma_4C = lcm[isig].p4_gam1_pi0_sigma_4C +
                                     lcm[isig].p4_gam2_pi0_sigma_4C +
                                     lcm[isig].p4_proton_sigma_4C;
      // HepLorentzVector p4_pi0_4C = lcm[isig].p4_gam1_pi0_4C +
      // lcm[isig].p4_gam2_pi0_4C;
      HepLorentzVector p4_eta_4C =
          lcm[isig].p4_gam1_eta_4C + lcm[isig].p4_gam2_eta_4C;
      HepLorentzVector pLambdac = p4_sigma_4C + p4_eta_4C;
      pLambdac.boost(-m_beta);
      m_deltaE_min[isig] = pLambdac.t() - ebeam;
      ...
      // m_sigmap = p4_sigma_4C.m() > 0 ? p4_sigma_4C.m() : -10;
      // m_eta = p4_eta_4C.m() > 0 ? p4_eta_4C.m() : -10;
      // HepLorentzVector p_pi0 = lcm[isig].p4_gam1_pi0_sigma_4C +
      // lcm[isig].p4_gam2_pi0_sigma_4C;
      // m_pi0 = p_pi0.m() > 0 ? p_pi0.m() : -10;
...
StatusCode LambdacSigmapEta::endRun() {
  if (m_debug)
    std::cerr << __LINE__ << "!!!!!!!!!! m_debug endRun !!!!!!!!!!"
              << std::endl;
  MsgStream log(msgSvc(), name());
...
StatusCode LambdacSigmapEta::finalize() {
  if (m_debug)
    std::cerr << __LINE__ << "!!!!!!!!!! m_debug begin finalize !!!!!!!!!!"
              << std::endl;
  MsgStream log(msgSvc(), name());
